...
const I18N = {
  it: {
    ...
    routingPickOnMap: "Sulla mappa",
    routingFindButton: "Calcola percorso",
    ...
    routeLtsSegmentTemplate: (km, descriptor) => `${km}km di percorso ${descriptor}`,
    routeFacilitySegmentTemplate: (km, label) => `${km}km di ${label}`,
...
<p>Per tutto il resto - <strong>l'algoritmo, il calcolo o il software</strong> - il codice pubblico permette di verificare il funzionamento e contribuire al suo miglioramento.</p>`,
  ...
  en: {
    ...
    routingEndLabel: "End",
    routingPickOnMap: "On map",
    routingFindButton: "Find route",
    ...
    routeLtsSegmentTemplate: (km, descriptor) => `${km}km of ${descriptor} riding`,
    routeFacilitySegmentTemplate: (km, label) => `${km}km of ${label}`,
...
<p>And, above all, <strong>where riding could be better</strong>.</p>`,
  ...
  de: {
    ...
    routingPickOnMap: "Auf der Karte",
    routingFindButton: "Route berechnen",
    ...
    routeLtsSegmentTemplate: (km, descriptor) => `${km}km auf einer Strecke, die ${descriptor} ist`,
    routeFacilitySegmentTemplate: (km, label) => `${km}km auf ${label}`,
...
<p>Und vor allem, <strong>wo man besser Rad fahren könnte</strong>.</p>`,
  ...
  fr: {
    ...
    routingPickOnMap: "Sur la carte",
    routingFindButton: "Calculer l'itinéraire",
    ...
    routeLtsSegmentTemplate: (km, descriptor) => `${km}km de parcours ${descriptor}`,
    routeFacilitySegmentTemplate: (km, label) => `${km}km de ${label}`,
